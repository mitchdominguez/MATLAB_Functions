...
function [x_m, x_h, x_p] = flyby(orbit1, planet, sun, flyby_radius)
    ...
    x_m.r_mag = planet.a;
    x_m.thstar = ta_conic(x_m.r_mag, orbit1.a, orbit1.e, 'deg'); % initial true anomaly
    ...
    x_m.gamma = fpa(x_m.r_mag, x_m.v_mag, sun.mu, orbit1.a, orbit1.e, 'deg'); % flight path angle
    ...
    x_h.delta = 2*asind(1/x_h.e); % Flyby angle [deg]
