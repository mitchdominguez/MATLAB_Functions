%% Mitchell Dominguez - doming18@purdue.edu - periodic_zfixed.m
% mu, ICs, target, tf, 

function soln = periodic_zfixed(mu, z_ic, tmax, ode_opts, max_iter, tol)
    ...
    while 1
        ...
        phi_21 = phi_aug_tf{i}(2,1); % dy/dx0
        phi_25 = phi_aug_tf{i}(2,5); % dy/dydot0
        phi_41 = phi_aug_tf{i}(4,1); % dxdot/dx0
        phi_45 = phi_aug_tf{i}(4,5); % dxdot/dydot0
        phi_61 = phi_aug_tf{i}(6,1); % dzdot/dx0
        ...
        mat = [phi_41, phi_45;phi_61, phi_65] - (1/ydot)*[xddot;zddot]*[phi_21, phi_25];
